...
int main(){
    ...
    printf("Character Name: %s %s", char_first_name, char_last_name);
    printf("Race: %s\nGender: %s\nAge: %s\nHeight: %s\nSkin Color: %s\nHair Color: %s\n", char_race, char_gender, char_age, char_height, char_skin_color, char_hair_color);
    printf("Build: %s\nAttire: %s\nProfession: %sPersonality: %s, %s, %s\n", char_build, char_attire, char_profession, char_trait, char_goal, char_flaw);
